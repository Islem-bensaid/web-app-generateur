...
export class AngularEditorComponent implements OnInit, ControlValueAccessor, AfterViewInit, OnDestroy {
    ...
    onMatFormFieldFocus(event: FocusEvent) {
        this.control.markAsTouched();
        const matFormField = document.getElementById(this.id + '-matFormField');
        this.floatLabel = true;
        this.r.addClass(matFormField, 'mat-form-field-should-float');
        this.r.addClass(matFormField, 'mat-focused');
        this.r.removeClass(matFormField, 'mat-form-field-hide-placeholder');
    }


    onMatFormFieldBlur(event: FocusEvent) {
        const matFormField = document.getElementById(this.id + '-matFormField');
        this.floatLabel = false;
        this.r.addClass(matFormField, 'mat-form-field-hide-placeholder');
        this.r.removeClass(matFormField, 'mat-form-field-should-float');
        this.r.removeClass(matFormField, 'mat-focused');
    }
