...
import { IMyExtension } from './IMyExtention';
...
export class MyExtension extends Extension implements IMyExtension {
  ...
  public load() {
    MyExtension.myStaticViewer = this.viewer;
  ...
  async isolateFull(dbIds = []) {
    let viewer = MyExtension.myStaticViewer;
...
// doesn't have any children
  ...
  public isolateItems(taskCodes) {
    ...
    getNodesDbIDsToIsolate(MyExtension.myStaticViewer);
  }
}
