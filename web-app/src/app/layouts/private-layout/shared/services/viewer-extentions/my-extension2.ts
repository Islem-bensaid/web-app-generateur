...
import {IMyExtension2} from './IMyExtention2';
...
export class MyExtension2 extends Extension implements IMyExtension2 {

  // Extension must have a name
  public static extensionName: string = 'MyExtension2';
  ...
  public load() {
    MyExtension2.myStaticViewer = this.viewer;
  ...
  async isolateFull(dbIds = []) {
    let viewer = MyExtension2.myStaticViewer;
...
// doesn't have any children
  ...
  public isolateItems(taskCodes) {
   ...
   return new Promise(resolve => resolve(getNodesDbIDsToIsolate(MyExtension2.myStaticViewer))) ;
  }
}
