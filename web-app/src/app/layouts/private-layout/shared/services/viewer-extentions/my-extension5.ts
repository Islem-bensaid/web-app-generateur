...
import {IMyExtension5} from './IMyExtention5';
...
export class MyExtension5 extends Extension implements IMyExtension5 {

  // Extension must have a name
  public static extensionName: string = 'MyExtension5';
  ...
  public load() {
    MyExtension5.myStaticViewer = this.viewer;
  ...
  async isolateFull(dbIds = []) {
    let viewer = MyExtension5.myStaticViewer;
...
// doesn't have any children
  ...
  public isolateItems(taskCodes) {
    ...
    return new Promise(resolve => resolve(getNodesDbIDsToIsolate(MyExtension5.myStaticViewer))) ;
  }
}
