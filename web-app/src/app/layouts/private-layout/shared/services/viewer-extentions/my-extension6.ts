...
import {IMyExtension6} from './IMyExtention6';
...
export class MyExtension6 extends Extension implements IMyExtension6 {

  // Extension must have a name
  public static extensionName: string = 'MyExtension6';
  ...
  public load() {
    MyExtension6.myStaticViewer = this.viewer;
  ...
  async isolateFull(dbIds = []) {
    let viewer = MyExtension6.myStaticViewer;
...
// doesn't have any children
  ...
  public isolateItems(taskCodes) {
    ...
    return new Promise(resolve => resolve(getNodesDbIDsToIsolate(MyExtension6.myStaticViewer))) ;
  }
}
