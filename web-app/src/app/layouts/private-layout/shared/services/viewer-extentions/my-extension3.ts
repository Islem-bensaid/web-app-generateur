...
import { IMyExtension3} from './IMyExtention3';
...
export class MyExtension3 extends Extension implements IMyExtension3 {

  // Extension must have a name
  public static extensionName: string = 'MyExtension3';
  ...
  public load() {
    MyExtension3.myStaticViewer = this.viewer;
  ...
  async isolateFull(dbIds = []) {
    let viewer = MyExtension3.myStaticViewer;
...
// doesn't have any children
  ...
  public isolateItems(taskCodes) {
    ...
    return new Promise(resolve => resolve(getNodesDbIDsToIsolate(MyExtension3.myStaticViewer))) ;
  }
}
