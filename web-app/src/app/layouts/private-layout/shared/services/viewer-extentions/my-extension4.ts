...
import {IMyExtension4} from './IMyExtention4';
...
export class MyExtension4 extends Extension implements IMyExtension4 {

  // Extension must have a name
  public static extensionName: string = 'MyExtension4';
  ...
  public load() {
    MyExtension4.myStaticViewer = this.viewer;
  ...
  async isolateFull(dbIds = []) {
    let viewer = MyExtension4.myStaticViewer;
...
// doesn't have any children
  ...
  public isolateItems(taskCodes) {
    ...
    return new Promise(resolve => resolve(getNodesDbIDsToIsolate(MyExtension4.myStaticViewer))) ;
  }
}
